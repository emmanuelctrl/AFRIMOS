...
export function StatusBadge({
  ...
  return (
    <span
      role="status"
      className={cn(
        'inline-flex items-center gap-2.5 rounded-full border border-espresso-900/10 bg-white/55 px-3.5 py-1.5 text-xs font-medium text-espresso-700 backdrop-blur-xl',
        className
      )}
    >
