export default function About() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="text-4xl font-bold text-gray-900">About AFRIMOS</h1>

      <section className="prose mt-8 max-w-none text-gray-700">
        ...
        <h2 className="mt-8 text-xl font-semibold text-gray-900">Vision</h2>
        <p className="mt-2">
        ...
        <p className="mt-2">
          ...
          <a href="mailto:admin@afrimos.et" className="text-brand-700 underline">
            admin@afrimos.et
          </a>
        </p>
      </section>
