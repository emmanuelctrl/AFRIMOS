      ...
      {conversations.length === 0 ? (
        ...
        <div className="card divide-y divide-white/10 p-0">
          {conversations.map((c) => (
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-500/20 font-semibold text-brand-400">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-sm text-gray-400">{c.lastMessage.messageBody}</p>
              </div>
